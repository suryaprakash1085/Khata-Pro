...
// //   // ⚠️ DELIVERY CREATION DISABLED - This is causing the 500 error
...
// // //     res.status(201).json(formatSalesOrder(order, customer.name, d.items.length));
// // //   } catch (err) {
// // //     console.error("[public/sales-orders] failed:", err); // full stack in your terminal
// // //     res.status(500).json({
...
// //       } catch (err) {
// //         console.error("[public/sales-orders] Failed to create delivery:", err);
// //         // don't fail the whole order just because delivery insert failed
// //       }
// //     }
...
>>>>>>> 7df26a8744e3b5687b536baee6aea9f81c9b586e
// import { Router, type IRouter } from "express";
// import { requireAuth, AuthPayload } from "../middlewares/auth";
// import {
//   db,
...
<<<<<<< HEAD
  // 👇 authoritative server-side delivery-fee snapshot
  const deliveryFeeSnapshot = await calculateAndSnapshotDeliveryFee(
    d.business_id,
    d.customer_latitude,
