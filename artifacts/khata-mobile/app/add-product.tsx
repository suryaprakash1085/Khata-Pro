...
// // @ts-ignore
// import { useCreateProduct, useUpdateProduct, useGetProduct, getGetProductQueryKey, getListProductsQueryKey, useListProducts, useListVendors, getListVendorsQueryKey, useCreateVendor } from '@workspace/api-client-react';
...
//     const onSettled = {
//       onSuccess: () => {
//         // Invalidate queries so that Current Stock / All Products views update instantly from the DB
...
//         // Success alert — navigates to Current Stock on OK (works on web + native)
//         showAlert(
//           'Success',
...
//         );
//       },
//       onError: () => setError(`Could not ${isEditMode ? 'update' : 'save'} product. Please try again.`),
//     };

//     if (isEditMode && productId) {
//       updateProduct.mutate({ id: productId, data: payload }, onSettled);
//     } else {
//       createProduct.mutate({ data: payload }, onSettled);
//     }
//   };
