...
//       const prev = map.get(r.transaction_id) ?? { qty: 0, amount: 0 };
//       prev.qty += r.qty;
...
//       return ret ? { ...r, returnedQty: ret.qty, returnedAmount: ret.amount } : r;
//     });
...
//       if (isExchange && exchangeCredit > 0) {
//         router.push({
//           pathname: '/billing',
//           params: {
//             customer_id: String(bill.customerId),
...
//             {item.returnedQty} item{item.returnedQty !== 1 ? 's' : ''} returned • {formatCurrency(item.returnedAmount, business?.currency)} refunded • Net {formatCurrency(item.amount - item.returnedAmount, business?.currency)}
//           </Text>
//         )}
//       </Pressable>
//     );
