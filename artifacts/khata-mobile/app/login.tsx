...
//   // Set the background image directly on <body> via DOM API on web.
//   // This sidesteps RN-Web's layout system entirely (position:'fixed' can get
//   // trapped by an ancestor with a CSS transform — GestureHandlerRootView /
//   // KeyboardProvider often add one — so it stops behaving like viewport-fixed).
//   useEffect(() => {
...
//     const bgUri = typeof bg === 'string' ? bg : bg?.default ?? bg;
...
//       document.body.style.backgroundAttachment = prevStyle.backgroundAttachment;
//     };
//   }, []);
...
//       {/* Overlay sits over the <body> background image set in the useEffect above */}
