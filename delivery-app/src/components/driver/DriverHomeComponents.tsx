...
// //         <TouchableOpacity style={styles.iconActionBtn} onPress={onCall}>
// //           <Ionicons name="call" size={16} color={COLORS.primary} />
// //         </TouchableOpacity>
// //         <TouchableOpacity style={styles.iconActionBtn} onPress={onNavigate}>
// //           <Ionicons name="navigate" size={16} color={COLORS.primary} />
// //         </TouchableOpacity>
// //         <TouchableOpacity style={styles.pickedUpBtn} onPress={onMarkPickedUp}>
...
// //   const meta = notifIconMeta[item.type];
// //   return (
...
// //   sectionAction: { fontSize: 12.5, fontWeight: '600', color: COLORS.primary },
...
// //   summaryLabel: { fontSize: 11, color: COLORS.slate, marginTop: 2 },
...
// //     marginBottom: 6,
// //   },
// //   quickActionLabel: { fontSize: 11.5, fontWeight: '600', color: COLORS.ink, textAlign: 'center' },
...
// //     marginBottom: 6,
// //   },
// //   circularValue: { fontSize: 13, fontWeight: '700' },
// //   circularLabel: { fontSize: 10.5, color: COLORS.slate, textAlign: 'center' },
...
// //   deliveryOrderId: { fontSize: 13, fontWeight: '700', color: COLORS.primary },
// //   deliveryCustomer: { fontSize: 15, fontWeight: '700', color: COLORS.ink, marginBottom: 6 },
// //   deliveryInfoRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 4 },
// //   deliveryInfoText: { fontSize: 12.5, color: COLORS.slate, flexShrink: 1 },
// //   deliveryFooterRow: {
// //     flexDirection: 'row',
// //     justifyContent: 'space-between',
// //     alignItems: 'center',
...
// //   },
// //   deliveryAmount: { fontSize: 15, fontWeight: '700', color: COLORS.ink },
// //   deliveryPayment: { fontSize: 11, color: COLORS.slate },
...
// //     borderRadius: 10,
// //   },
// //   pickedUpBtnText: { fontSize: 11, fontWeight: '700', color: '#FFFFFF' },
...
// //     paddingVertical: 6,
// //   },
// //   scheduleTime: { fontSize: 11, fontWeight: '700', color: COLORS.primary },
// //   scheduleCustomer: { fontSize: 13.5, fontWeight: '600', color: COLORS.ink },
// //   scheduleOrderId: { fontSize: 11, color: COLORS.slate, marginTop: 1 },
...
// //   notifMessage: { fontSize: 13, color: COLORS.ink, fontWeight: '500' },
// //   notifTime: { fontSize: 11, color: COLORS.slateLight, marginTop: 2 },
// // });
