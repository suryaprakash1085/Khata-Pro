...
// // // //   // ✅ Fixed: Handle cart button press with proper navigation
// // // //   const handleCartPress = () => {
// // // //     console.log('🛒 Cart button pressed');
// // // //     console.log('📦 Cart items:', cartItems);
// // // //     console.log('🎯 Navigating to Cart screen');
    
// // // //     // Try to navigate to Cart screen
// // // //     try {
// // // //       navigation.navigate('Cart');
// // // //     } catch (error) {
// // // //       console.error('❌ Navigation error:', error);
// // // //       // If navigation fails, try alternative navigation
...
// // // //       {/* ✅ Fixed: Cart button with proper navigation */}
// // // //       {cartItems.length > 0 && cartItems.some(item => item.restaurantId === restaurantData.id) && (
// // // //         <TouchableOpacity
// // // //           style={styles.cartButton}
...
// // //   // ✅ FIXED: Handle cart button press with multiple navigation approaches
// // //   const handleCartPress = () => {
// // //     console.log('🛒 Cart button pressed');
...
// // //     // Approach 1: Try direct navigation to Cart
// // //     try {
// // //       navigation.navigate('Cart');
// // //       console.log('✅ Approach 1: Direct navigation succeeded');
// // //       return;
// // //     } catch (e1) {
// // //       console.log('❌ Approach 1 failed:', e1);
// // //     }
    
// // //     // Approach 2: Try parent navigation (if Cart is in parent navigator)
// // //     try {
// // //       if (parent) {
// // //         parent.navigate('Cart');
// // //         console.log('✅ Approach 2: Parent navigation succeeded');
// // //         return;
// // //       }
// // //     } catch (e2) {
...
// // //     // Approach 3: Try navigating through MainTabs (if Cart is a tab)
// // //     try {
// // //       if (parent) {
// // //         parent.navigate('MainTabs', { screen: 'Cart' });
// // //         console.log('✅ Approach 3: MainTabs navigation succeeded');
// // //         return;
// // //       }
// // //     } catch (e3) {
// // //       console.log('❌ Approach 3 failed:', e3);
// // //     }
    
// // //     // Approach 4: Try navigating to Home first then Cart
// // //     try {
// // //       if (parent) {
...
// // //           navigation.navigate('Cart');
// // //         }, 300);
// // //         console.log('✅ Approach 4: Home then Cart navigation succeeded');
// // //         return;
// // //       }
// // //     } catch (e4) {
// // //       console.log('❌ Approach 4 failed:', e4);
// // //     }
    
// // //     // Approach 5: Try root navigator
// // //     try {
// // //       const rootNavigator = navigation.getParent()?.getParent();
// // //       if (rootNavigator) {
// // //         rootNavigator.navigate('Cart');
// // //         console.log('✅ Approach 5: Root navigator navigation succeeded');
// // //         return;
// // //       }
// // //     } catch (e5) {
// // //       console.log('❌ Approach 5 failed:', e5);
// // //     }
    
// // //     // If all approaches fail, show alert
// // //     Alert.alert(
// // //       'Navigation Error',
// // //       'Unable to navigate to Cart. Please try again.',
// // //       [
// // //         { 
// // //           text: 'Go to Home', 
...
// //         try {
// //           parent.navigate('Cart');
// //           console.log('✅ Navigated via parent successfully');
// //           return;
// //         } catch (e) {
...
// //       // Try navigating through MainTabs
// //       try {
// //         if (parent) {
// //           parent.navigate('MainTabs', { 
// //             screen: 'Cart' 
// //           });
// //           console.log('✅ Navigated via MainTabs successfully');
// //           return;
// //         }
// //       } catch (e) {
// //         console.log('❌ MainTabs navigation failed:', e);
// //       }
...
// //         if (root) {
// //           root.navigate('Cart');
// //           console.log('✅ Navigated via root successfully');
// //           return;
// //         }
// //       } catch (e) {
// //         console.log('❌ Root navigation failed:', e);
// //       }
      
// //       // If all fail, show alert with fallback options
// //       Alert.alert(
// //         'Navigation Error',
// //         'Unable to navigate to cart. Please try again or go back to home.',
// //         [
// //           { 
// //             text: 'Go to Home', 
// //             onPress: () => navigation.navigate('Home') 
...
//   // ✅ FIXED: Direct navigation to Cart tab without goBack()
//   const handleCartPress = () => {
//     console.log('🛒 Cart button pressed');
//     console.log('📦 Cart items count:', cartItems.length);
    
//     try {
//       // Get the parent navigator (MainStack)
//       const parent = navigation.getParent();
//       console.log('👨‍👩‍👦 Parent navigator exists:', !!parent);
      
//       if (parent) {
//         // Navigate directly to Cart tab within HomeTabs
//         parent.navigate('HomeTabs', {
//           screen: 'Cart',
//           params: {
//             // Optional: pass any params if needed
//           },
//         });
//         console.log('✅ Navigated to Cart tab successfully');
//         return;
//       }
      
//       // Fallback: Try direct navigation
//       navigation.navigate('Cart');
//       console.log('✅ Navigated to Cart directly');
      
//     } catch (error) {
//       console.log('❌ Navigation failed:', error);
      
//       // Try alternative approach: reset navigation
//       try {
//         navigation.reset({
//           index: 0,
//           routes: [
...
//           ],
//         });
//         // After reset, navigate to Cart
//         setTimeout(() => {
//           navigation.navigate('Cart');
//         }, 300);
//         console.log('✅ Navigated via reset');
//       } catch (e) {
//         console.log('❌ Reset navigation failed:', e);
...
//       {/* ✅ Cart button with proper navigation to Cart tab */}
//       {cartItems.length > 0 && cartItems.some(item => item.restaurantId === restaurantData.id) && (
//         <TouchableOpacity
//           style={styles.cartButton}
//           onPress={handleCartPress}
...
const RestaurantDetailScreen: React.FC<RestaurantDetailScreenProps> = ({ route, navigation }) => {
  ...
  // ✅ FIXED: Direct navigation to Cart using multiple approaches
  const handleCartPress = () => {
    console.log('🛒 Cart button pressed');
    console.log('📦 Cart items count:', cartItems.length);
    
    // Approach 1: Try using CommonActions to navigate to Cart tab
    try {
      navigation.dispatch(
      ...
      console.log('✅ Navigated to Cart using CommonActions');
      return;
    } catch (error) {
      console.log('❌ CommonActions navigation failed:', error);
    }

    // Approach 2: Try parent navigation
    try {
      const parent = navigation.getParent();
      if (parent) {
        parent.navigate('HomeTabs', {
        ...
        console.log('✅ Navigated to Cart via parent');
        return;
      }
    } catch (error) {
    ...
    // Approach 3: Try direct navigation (if Cart is in the same stack)
    try {
      navigation.navigate('Cart');
      console.log('✅ Navigated to Cart directly');
      return;
    ...
    // Approach 4: Try reset navigation
    try {
      navigation.dispatch(
        CommonActions.reset({
          index: 0,
      ...
      console.log('✅ Navigated to Cart via reset');
      return;
    } catch (error) {
      console.log('❌ Reset navigation failed:', error);
    }

    // Approach 5: Try going back to HomeTabs first then navigate to Cart
    try {
      navigation.goBack();
      setTimeout(() => {
        const parent = navigation.getParent();
      ...
      console.log('✅ Navigated via goBack + navigate');
      return;
    } catch (error) {
      console.log('❌ goBack + navigate failed:', error);
    }
