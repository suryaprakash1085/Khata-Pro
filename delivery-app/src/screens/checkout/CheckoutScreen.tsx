...
// // // //   const { cartItems, getTotalPrice, getTotalItems, clearCart } = useContext(CartContext);
...
// // // //   useEffect(() => {
// // // //     if (!selectedAddress) {
// // // //       // Try to get default address from user or use mock
// // // //       setSelectedAddress({
// // // //         id: '1',
// // // //         type: 'Home',
...
// // // //   const tax: number = Math.round(getTotalPrice() * 0.05);
// // // //   const total: number = getTotalPrice() + deliveryFee + platformFee + tax;
...
// // // //     }
// // // //   }, [route.params?.selectedAddress, route.params?.selectedPayment]);
...
// // //       setSelectedAddress(route.params.selectedAddress);
// // //     } else {
// // //       // Load default address from context
...
// //   // Get selected address from route params or load default
// //   useEffect(() => {
// //     // Check if order was just placed and cart is empty
...
// //   // Show empty cart message if cart is empty (after order placed)
// //   if (cartItems.length === 0 && isOrderPlaced) {
// //     return (
// //       <View style={styles.container}>
// //         <View style={styles.header}>
...
//   // 🔥 FIX: Direct calculation of item total from cart items
...
//   // Use direct calculation instead of getTotalPrice
//   const itemTotal = calculateItemTotal();
//   const deliveryFee: number = 47;
//   const platformFee: number = 7;
//   const tax: number = Math.round(itemTotal * 0.05);
//   const total: number = itemTotal + deliveryFee + platformFee + tax;
