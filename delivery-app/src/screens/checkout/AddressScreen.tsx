...
// // //     setNewAddress({ type: 'Home', address: '', city: '', state: '', pincode: '' });
...
// // //       >
// // //         <Text style={styles.selectButtonText}>Select This Address</Text>
// // //       </TouchableOpacity>
// // //     </View>
// // //   );
...
//           longitude,
//         });
//         Alert.alert('Location Found', 'Your current location has been added');
//       }
//     } catch (error) {
...
//     setNewAddress({ type: 'Home', address: '', city: '', state: '', pincode: '', landmark: '', phone: user?.phone || '' });
//     setShowAddForm(false);
//     setEditingId(null);
//   };
