...
// // // // // // // // //       console.log('Products for store:', response.data);
...
// // // // // // // //       <View style={styles.loadingContainer}>
// // // // // // // //         <ActivityIndicator size="large" color={colors.primary} />
// // // // // // // //         <Text style={styles.loadingText}>Loading products for {storeName || 'store'}...</Text>
// // // // // // // //       </View>
// // // // // // // //     );
// // // // // // // //   }
...
// // // // // // // //             <TouchableOpacity style={styles.retryButton} onPress={() => loadProducts(storeId)}>
...
// // // // // // //   // Render Product Card - New UI Design
// // // // // // //   const renderProduct = ({ item }: { item: any }) => {
// // // // // // //     const inCart = isItemInCart(item.id);
// // // // // // //     const quantity = getItemQuantity(item.id);
...
// // // // // //     // Store the current store context before navigating
...
// // // // //   // ✅ Apply category filter when search is empty
...
// // // // //   // ✅ Filter products by category (with search override)
// // // // //   useEffect(() => {
...
// // // //   // ✅ FIXED: Combined filter for search and category
// // // //   useEffect(() => {
// // // //     const filterProducts = () => {
// // // //       let filtered = [...products];

// // // //       // Apply category filter only when search is empty
// // // //       if (searchQuery.trim().length === 0) {
// // // //         if (selectedCategory !== 'All' && selectedCategory) {
...
// // // //       // Apply search filter when search has content
// // // //       if (searchQuery.trim().length > 0) {
// // // //         const query = searchQuery.toLowerCase().trim();
...
// // //   // ✅ FIXED: Combined filter for search and category with proper case-insensitive search
// // //   useEffect(() => {
// // //     const filterProducts = () => {
// // //       let filtered = [...products];

// // //       // If search has content, apply search filter (overrides category)
// // //       if (searchQuery.trim().length > 0) {
// // //         const query = searchQuery.toLowerCase().trim();
// // //         filtered = filtered.filter(product => {
// // //           const name = (product.name || '').toLowerCase();
...
// //                     style={[
// //                       styles.filterChip,
// //                       tempSelectedCategory === category && styles.filterChipActive,
// //                     ]}
...
// //                         tempSelectedCategory === category && styles.filterChipTextActive,
// //                       ]}
// //                     >
// //                       {category}
// //                     </Text>
