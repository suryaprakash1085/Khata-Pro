...
// //       {/* Products List - Fixed contentContainerStyle */}
// //       <FlatList
...
//   // ✅ NEW BUSINESS DESCRIPTION STATES
...
//   // ✅ NEW: Fetch Business Details (to get description)
//   useEffect(() => {
...
export default function ProductListScreen({ route, navigation }: any) {
  ...
  // not the product's id — this is what CartScreen's business_id resolution relies on.
  const handleAddToCart = (product: any) => {
    if (!selectedStoreId) {
      Alert.alert('Error', 'No store selected');
      return;
...
const styles = StyleSheet.create({
  ...
  headerDescription: { fontSize: 12, color: colors.textLight, marginTop: 4, lineHeight: 16 },
