...
//   // =====================================================
//   // ✅ UPDATED: Show selected store from order, NOT login
//   // =====================================================
//   // Get assigned store from localStorage (from login)
//   const assignedStoreId = typeof window !== 'undefined' 
//     ? JSON.parse(localStorage.getItem('user') || '{}')?.assignedStoreId 
//     : null;
  
//   // Find the assigned store name from businesses list
//   const assignedStore = businesses.find(
//     (biz) => String(biz.id) === String(assignedStoreId)
//   );
  
//   // Get business name - use assigned store name if available, otherwise show "Select a Store"
//   const businessName = assignedStore?.business_name || assignedStore?.businessName || 'Select a Store';
//   const plan = assignedStore?.business_plan || user?.business_plan || 'FREE';
//   const displayName = businessName.length > 20 ? businessName.substring(0, 20) + '...' : businessName;
...
//     onPress={() => {
//       console.log('🛒 Clicked store:', item.business_name, 'ID:', item.id);
//       // ✅ Sync context so downstream screens (Cart/Checkout) use the right store
//       setSelectedBusiness({
//         id: item.id,
...
//       showsVerticalScrollIndicator={false}
//     >
//       {/* HEADER - UPDATED to show selected store from order, NOT login */}
//       <View style={styles.header}>
//         <View style={styles.headerLeft}>
//           <Text style={styles.locationLabel}>📍 Home</Text>
//           <Text style={styles.location}>Sector 1, HSR Layout</Text>
 
//           {/* ✅ UPDATED - Shows the store where order was placed */}
//           <View style={styles.businessCard}>
//             <View style={styles.businessCardContent}>
