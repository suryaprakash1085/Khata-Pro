...
// // // // // //   // 🔥 DYNAMIC REAL-TIME NOTIFICATION PARSER

// // // // // //   // ------------------------------------------------------------
 
// // // // // //   // ✅ REAL-TIME DYNAMIC TIME FORMATTER
...
// // // // // //       else return date.toLocaleDateString('en-IN', {
...
// // // // // //       const addressMatch = rawMessage ? rawMessage.match(/deliver to ([^.]+)/) : null;
// // // // // //       if (addressMatch && addressMatch[1]) {
// // // // // //         deliveryLocation = addressMatch[1].trim();
// // // // // //       } else {
// // // // // //         deliveryLocation = rawMessage || 'Preparing...';
// // // // // //       }
...
// // // // // //       bodyText = 'A driver has been assigned to deliver your order.';
      
// // // // // //       const driverMatch = rawMessage ? rawMessage.match(/Driver ([^ ]+)/) : null;
// // // // // //       const addressMatch = rawMessage ? rawMessage.match(/deliver to ([^.]+)/) : null;
      
// // // // // //       if (driverMatch && driverMatch[1]) {
// // // // // //         deliveryLocation = `Driver ${driverMatch[1]} • ${addressMatch ? addressMatch[1].trim() : 'on the way'}`;
...
// // // // // // <View style={styles.amazonTitleRow}>
// // // // // // <View style={styles.amazonIconCircle}>
// // // // // // <Icon name={item.type === 'assigned' ? "person-outline" : "bag-check-outline"} size={18} color="#fff" />
// // // // // // </View>
// // // // // // <View style={styles.amazonTitleColumn}>
// // // // // // <Text style={styles.amazonTitleText}>{title}</Text>
// // // // // // <Text style={styles.amazonTimeText}>
...
// // // // // // <View style={styles.amazonDeliveryCard}>
// // // // // // <View style={styles.amazonDeliveryLeft}>
// // // // // // <Text style={styles.amazonDeliveryTitle}>
// // // // // //                 {item.type === 'assigned' ? 'Driver & Delivery' : 'Arriving by'}
// // // // // // </Text>
// // // // // // <Text style={styles.amazonDeliveryDate}>{deliveryLocation}</Text>
// // // // // // </View>
// // // // // // <View style={styles.amazonProductImagePlaceholder} />
...
// // // // // //   // ============================================================
// // // // // //   const handleAssignDriver = async (item: any, driverName: string = 'Rajesh') => {
// // // // // //     try {
// // // // // //       setRefreshing(true);
...
// // // // // //       // 2. Create ASSIGN notification
// // // // // //       const deliveryAddress = item.deliveryAddress || item.delivery_location || 'address not specified';
// // // // // //       await notificationService.createOrderConfirmationNotification({
// // // // // //         orderId: parseInt(item.id),
// // // // // //         businessId: parseInt(businessId),
// // // // // //         customerId: user?.id,
// // // // // //         type: 'assigned',
// // // // // //         messageText: `Driver ${driverName} assigned to order #${item.id}. Deliver to ${deliveryAddress}`
// // // // // //       });

// // // // // //       // 3. Update local state
// // // // // //       setOrdersList(prev => prev.map(order => 
// // // // // //         order.id === item.id 
// // // // // //           ? { ...order, status: 'On the way', driver: driverName } 
// // // // // //           : order
// // // // // //       ));

// // // // // //       Alert.alert('✅ Driver Assigned', `Driver ${driverName} has been assigned to this order.`, [{ text: 'OK' }]);
// // // // // //       onRefresh();
...
// // // // // //     // Show Assign Driver button for current orders that are not delivered/cancelled
// // // // // //     const showAssignButton = isCurrent && !isDelivered && item.status !== 'Cancelled' && item.status !== 'On the way';
    
// // // // // //     // Show Cancel button for current orders that are not delivered/cancelled
// // // // // //     const showCancelButton = isCurrent && !isDelivered && item.status !== 'Cancelled';
...
// // // // // //                         text: 'Yes, Assign', 
// // // // // //                         onPress: () => {
// // // // // //                           // You can show driver selection here
// // // // // //                           handleAssignDriver(item, 'Rajesh');
// // // // // //                         }
// // // // // //                       }
// // // // // //                     ]
// // // // // //                   );
...
// // // // // //                 activeOpacity={0.8}
// // // // // //               >
// // // // // //                 <Icon name="person-outline" size={14} color="#007bff" />
...
// // // // // //   footerButtons: { flexDirection: 'row', alignItems: 'center', gap: 8, flexWrap: 'wrap' },

// // // // // //   // ASSIGN DRIVER BUTTON
// // // // // //   assignButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#e3f2fd', paddingHorizontal: 14, paddingVertical: 7, borderRadius: 6, borderWidth: 1, borderColor: '#007bff' },

// // // // // //   assignButtonText: { color: '#007bff', fontSize: 12, fontWeight: '500', marginLeft: 4 },
...
// // // //   //     let orderMatch = rawMessage ? rawMessage.match(/order #(\d+)/i) : null;
// // // //   //     if (orderMatch && orderMatch[1]) {
// // // //   //       orderId = `Order #${orderMatch[1]}`;
// // // //   //     } else {
// // // //   //       // Try to extract any order ID format (like ORD-MSX3)
// // // //   //       const orderIdMatch = rawMessage ? rawMessage.match(/order #([^\s.]+)/i) : null;
// // // //   //       if (orderIdMatch && orderIdMatch[1]) {
// // // //   //         orderId = `Order #${orderIdMatch[1]}`;
// // // //   //       }
// // // //   //     }
...
// // // //   // };
// // // //    // ------------------------------------------------------------
// // // //   // 🔥 FULLY DYNAMIC REAL-TIME NOTIFICATION PARSER
// // // //   // ------------------------------------------------------------
// // // //   // const parseAmazonRealUI = (
// // // //   //   type: string, 
// // // //   //   rawMessage: string, 
...
// // // //   //   let bodyText = 'Your order status has been updated.';
// // // //   //   let deliveryLocation = 'Preparing...';
// // // //   //   let orderId = `Order #---`; // Default placeholder
// // // //   //   let buttonText = 'View order details';
// // // //   //   let isUnread = !isRead;

// // // //   //   // console.log('📝 Parsing notification:', { type, rawMessage, id });

// // // //   //   // ✅ DYNAMICALLY EXTRACT THE REAL ORDER ID FROM THE DATABASE MESSAGE
// // // //   //   let orderMatch = rawMessage ? rawMessage.match(/order #(\d+)/i) : null;
// // // //   //   if (orderMatch && orderMatch[1]) {
// // // //   //     orderId = `Order #${orderMatch[1]}`;
// // // //   //   }

// // // //   //   // ✅ DYNAMICALLY EXTRACT DELIVERY ADDRESS
// // // //   //   const addressMatch = rawMessage ? rawMessage.match(/deliver to ([^.]+)/) : null;
// // // //   //   const extractAddress = addressMatch && addressMatch[1] ? addressMatch[1].trim() : (rawMessage || 'Preparing...');

// // // //   //   if (type === 'confirmed') {
// // // //   //     title = 'Your order is confirmed';
// // // //   //     bodyText = 'Thank you for your order. Your order has been confirmed.';
// // // //   //     deliveryLocation = extractAddress;

// // // //   //   } else if (type === 'assigned') {
// // // //   //     title = 'Driver assigned to your order';
// // // //   //     bodyText = 'A driver has been assigned to deliver your order.';
      
// // // //   //     // ✅ Extract driver name specifically for 'assigned' type
// // // //   //     const driverMatch = rawMessage ? rawMessage.match(/Driver ([^ ]+)/) : null;
      
// // // //   //     if (driverMatch && driverMatch[1]) {
// // // //   //       deliveryLocation = `Driver ${driverMatch[1]} • ${extractAddress}`;
// // // //   //     } else {
// // // //   //       deliveryLocation = extractAddress;
// // // //   //     }
...
// // // //   //   return { title, bodyText, deliveryLocation, orderId, buttonText, isUnread };
// // // //   // };
// // // //   // OrdersScreen.tsx - Updated parser
// // // // const parseAmazonRealUI = (
// // // //   type: string, 
// // // //   rawMessage: string, 
// // // //   id: number, 
...
// // // //   // ✅ SEPARATE UI FOR EACH NOTIFICATION TYPE
// // // //   if (type === 'confirmed') {
// // // //     // 📦 ORDER CONFIRMATION - Show "Your order is confirmed"
// // // //     title = 'Your order is confirmed';
// // // //     bodyText = 'Thank you for your order. Your order has been placed successfully.';
// // // //     deliveryLocation = 'Order Placed';
// // // //     buttonText = 'View order details';

// // // //   } else if (type === 'assigned') {
// // // //     // 🚗 DRIVER ASSIGNMENT - Show driver assigned
// // // //     title = 'Driver assigned to your order';
// // // //     bodyText = 'A driver has been assigned to deliver your order.';
    
// // // //     // Extract driver name from message
// // // //     const driverMatch = rawMessage ? rawMessage.match(/Driver ([^ ]+)/) : null;
// // // //     const addressMatch = rawMessage ? rawMessage.match(/order #\d+\.? ([^.]+)/) : null;
    
// // // //     if (driverMatch && driverMatch[1]) {
// // // //       deliveryLocation = `Driver ${driverMatch[1]} • On the way`;
// // // //     } else {
// // // //       deliveryLocation = 'Driver assigned • On the way';
// // // //     }
...
// // // //   // ============================================================
// // // //   // 🔥 HANDLE ASSIGN DRIVER - FIXED
// // // //   // ============================================================
// // // //   // const handleAssignDriver = async (item: any, driverName: string = 'Rajesh') => {
// // // //   //   try {
// // // //   //     setRefreshing(true);

// // // //   //     console.log('📦 Order ID being assigned:', item.id);
// // // //   //     console.log('📦 Full order data:', item);

// // // //   //     // Get the actual delivery ID from the item
...
// // // //   //     // 2. Create ASSIGN notification with the correct order ID
// // // //   //     const deliveryAddress = item.deliveryAddress || item.delivery_location || 'address not specified';
      
// // // //   //     // Pass the actual delivery ID in the message
// // // //   //     await notificationService.createOrderConfirmationNotification({
// // // //   //       orderId: parseInt(deliveryId) || 0,
// // // //   //       businessId: parseInt(businessId),
// // // //   //       customerId: user?.id,
// // // //   //       type: 'assigned',
// // // //   //       messageText: `Driver ${driverName} assigned to order #${deliveryId}. Deliver to ${deliveryAddress}`
// // // //   //     });
...
// // // //       // 2. Create NOTIFICATION with TYPE 'assigned'
// // // //       const deliveryAddress = item.deliveryAddress || item.delivery_location || 'address not specified';
...
// // // //         businessId: parseInt(businessId),
// // // //         customerId: user?.id,
// // // //         type: 'assigned', // ✅ TELL BACKEND THIS IS ASSIGNED
...
// // //   // 🔥 DYNAMIC REAL-TIME NOTIFICATION PARSER - UPDATED
...
// // //   // ✅ UPDATED PARSER - SEPARATE UI FOR EACH NOTIFICATION TYPE
...
// // //   //     title = 'Order Update';
// // //   //     bodyText = rawMessage || 'Your order status has been updated.';
// // //   //     deliveryLocation = 'Preparing...';
// // //   //     buttonText = 'View order details';
// // //   //   }
...
// // //   // OrdersScreen.tsx - Fixed parser with separate content for each type
// // // const parseAmazonRealUI = (
// // //   type: string, 
// // //   rawMessage: string, 
// // //   id: number, 
...
// // //   // ✅ SEPARATE UI FOR EACH NOTIFICATION TYPE
// // //   if (type === 'confirmed') {
// // //     // 📦 ORDER CONFIRMATION - Shows "Your order is confirmed"
// // //     title = 'Your order is confirmed';
// // //     bodyText = 'Thank you for your order. Your order has been placed successfully.';
// // //     deliveryLocation = 'Order Placed ✓';
// // //     buttonText = 'View order details';
...
// // //   } else if (type === 'assigned') {
// // //     // 🚗 DRIVER ASSIGNMENT - Shows "Driver assigned to your order"
// // //     title = 'Driver assigned to your order';
// // //     bodyText = 'A driver has been assigned to deliver your order.';
...
// // //   // RENDER NOTIFICATION - UPDATED WITH DYNAMIC ICONS
...
// // //   //   const getIconName = () => {
// // //   //     if (item.type === 'assigned') return "person-outline";
// // //   //     if (item.type === 'confirmed') return "bag-check-outline";
// // //   //     if (item.type === 'delivered') return "checkmark-circle-outline";
// // //   //     if (item.type === 'cancelled') return "close-circle-outline";
// // //   //     return "notifications-outline";
// // //   //   };

// // //   //   const getIconColor = () => {
// // //   //     if (item.type === 'assigned') return "#ff9900";
// // //   //     if (item.type === 'confirmed') return "#28a745";
// // //   //     if (item.type === 'delivered') return "#28a745";
// // //   //     if (item.type === 'cancelled') return "#dc3545";
// // //   //     return "#007185";
// // //   //   };
...
// // //   //       <View style={styles.amazonCardHeader}>
// // //   //         <View style={styles.amazonTitleRow}>
// // //   //           <View style={[styles.amazonIconCircle, { backgroundColor: iconColor }]}>
...
// // //   // };
// // //  // OrdersScreen.tsx - Updated renderNotification with proper icons
// // // const renderNotification = ({ item }: { item: Notification }) => {
...
// // //   const getIconName = () => {
// // //     if (item.type === 'assigned') return "person-outline";
// // //     if (item.type === 'confirmed') return "checkmark-circle-outline";
// // //     if (item.type === 'delivered') return "checkmark-circle-outline";
// // //     if (item.type === 'cancelled') return "close-circle-outline";
// // //     return "notifications-outline";
// // //   };
...
// // //   const getIconColor = () => {
// // //     if (item.type === 'assigned') return "#ff9900"; // Orange for driver
// // //     if (item.type === 'confirmed') return "#28a745"; // Green for confirmed
// // //     if (item.type === 'delivered') return "#28a745"; // Green for delivered
// // //     if (item.type === 'cancelled') return "#dc3545"; // Red for cancelled
// // //     return "#007185";
// // //   };

// // //   const getDeliveryTitle = () => {
// // //     if (item.type === 'assigned') return 'Driver & Delivery';
// // //     if (item.type === 'confirmed') return 'Order Status';
// // //     if (item.type === 'delivered') return 'Delivery Status';
// // //     if (item.type === 'cancelled') return 'Order Status';
// // //     return 'Status';
// // //   };
...
// // //       <View style={styles.amazonDeliveryCard}>
// // //         <View style={styles.amazonDeliveryLeft}>
// // //           <Text style={styles.amazonDeliveryTitle}>{deliveryTitle}</Text>
// // //           <Text style={styles.amazonDeliveryDate}>{deliveryLocation}</Text>
// // //         </View>
// // //         <View style={styles.amazonProductImagePlaceholder} />
// // //       </View>
...
// // //       // 2. ✅ Send DRIVER ASSIGNMENT notification with type 'assigned'
// // //       const deliveryAddress = item.deliveryAddress || item.delivery_location || 'address not specified';
...
// // //         businessId: parseInt(businessId),
// // //         customerId: user?.id,
// // //         type: 'assigned', // ✅ This creates "Driver assigned to your order"
// // //         deliveryAddress: deliveryAddress,
// // //         driverName: driverName // ✅ Pass driver name
// // //       });
...
// //   // ✅ PARSER - SEPARATE UI FOR EACH NOTIFICATION TYPE
// //   const parseAmazonRealUI = (
// //     type: string, 
// //     rawMessage: string, 
// //     id: number, 
...
// //   // ------------------------------------------------------------
// //   // RENDER NOTIFICATION - WITH DYNAMIC ICONS
// //   // ------------------------------------------------------------
...
// //       // 2. ✅ Send DRIVER ASSIGNMENT notification
// //       const deliveryAddress = item.deliveryAddress || item.delivery_location || 'address not specified';
...
// //   // ============================================================
// //   // 🔥 HANDLE CONFIRM ORDER - FOR ADMIN PANEL
// //   // ============================================================

// //   const handleConfirmOrder = async (deliveryData: any) => {
// //     try {
// //       setLoading(true);
...
// //           updated_at: new Date().toISOString()
// //         })
// //         .eq('order_id', deliveryData.orderId);
...
// //           updated_at: new Date().toISOString()
// //         })
// //         .eq('id', deliveryData.deliveryId);

// //       // 3. ✅ Send ORDER CONFIRMATION notification to customer
// //       await notificationService.createOrderConfirmationNotification({
// //         orderId: deliveryData.orderId,
// //         businessId: parseInt(businessId),
// //         customerId: deliveryData.customerId,
// //         type: 'confirmed',
// //         deliveryAddress: deliveryData.deliveryLocation || 'address not specified'
// //       });

// //       Alert.alert('✅ Order Confirmed', 'Order has been confirmed and customer has been notified.');
...
// //     setNotifications(prev => prev.filter(n => n.id !== notificationId));
// //   };
//   // ✅ Removes card instantly from screen AND deletes on backend (no confirm alert)
//   const handleCloseNotification = async (notificationId: number) => {
//     // Remove immediately from UI first (instant feedback)
//     setNotifications(prev => prev.filter(n => String(n.id) !== String(notificationId)));

//     // Then delete on the server so it doesn't come back on next fetch
//     try {
//       await notificationService.deleteNotification(notificationId);
//     } catch (error) {
//       console.error('Error deleting notification:', error);
...
const OrdersScreen: React.FC = ({ navigation }: any) => {
  ...
  const { orders, updateOrderStatus } = useContext(OrderContext);
  const { user } = useContext(AuthContext);
  // ✅ The store the customer actually shopped at / placed the order with
  ...
  // Get IDs
  const driverId = user?.driver_id;
  // ✅ FIXED: prefer the selected store's business_id (matches the order
  // that was actually created via PaymentScreen). Fall back to the
  // logged-in user's own assigned business only if nothing was selected
  // (covers staff/driver-style accounts that don't go through store selection).
...
const renderNotification = ({ item }: { item: Notification }) => {
  const { title, bodyText, deliveryLocation, orderId, buttonText, isUnread } = parseAmazonRealUI(
    item.type,
    item.message,  // ✅ Changed from message_text to message
    item.id,
    item.createdAt || item.created_at,
    item.isRead ?? item.is_read,
  );
      ...
      <View style={styles.amazonCard}>
        <View style={styles.amazonCardHeader}>
          ...
          <View style={styles.amazonHeaderRight}>
            {isUnread && <View style={styles.amazonUnreadDot} />}
            <TouchableOpacity
              onPress={() => handleCloseNotification(item.id)}
  ...
  const onRefresh = useCallback(() => {
    ...
    if (showNotifications) fetchNotifications();
    setTimeout(() => setRefreshing(false), 1000);
  }, [orders, showNotifications, businessId]);
